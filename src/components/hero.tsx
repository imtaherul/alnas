...
import {
  ...
  StarShape,
  QuarterCircle,
} from "@/components/home/shape-svg";
                    ...
                    <div className="hidden lg:flex relative justify-between w-full sm:w-[95%] pt-4">
                      {steps.map((step, i) => (
                        ...
                        >
                          {i < steps.length - 1 && (
                            <div
                              className={`absolute top-[7px] left-1/2 h-[2px] w-full z-0 ${i < current ? "bg-teal-700" : "bg-gray-200"}`}
                            />
                          )}
                          <button
                            type="button"
                    ...
                    <div className="mt-8 w-full">
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                        <div className="grid place-items-center">
                          <div className="rounded-lg border border-gray-200 bg-white w-50 h-40 items-center justify-center flex px-8">
                            <img
                        ...
                        <div className="col-span-1 lg:col-span-2">
                          <div className="flex flex-col gap-2 sm:gap-4">
                            <p className="text-lg font-semibold text-teal-700 leading-[1.6] text-start">
                              Step {current + 1} of {steps.length}
                            </p>
                            <h3 className="text-[16px] font-bold text-black text-start">
                              {steps[current].title}
                            </h3>
                            <p className="leading-[1.75] text-gray-700 h-10 text-start">
                              {steps[current].desc}
                            </p>
